...
const Hero = () => {
    ...
    return (
        <section className="w-full bg-hero-gradient overflow-hidden  py-15 md:py-16">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 md:gap-10 relative">
      
         {/* Left Content */}
        
<div className="w-full  md:w-1/2 relative pl-4 pt-10 pb-15 sm:pl-10 md:pl-20 lg:pl-40 flex flex-col justify-center  text-center">


{/* Text shifted slightly toward center */}
<motion.div
...
whileInView={{ opacity: 1, y: 0, scale: 1 }}
  ...
  className="relative flex-shrink-0">
              ...
              <img
                src={BAG}
                alt="Crochet Bag"
                className="w-full max-w-[400px] sm:max-w-[300px] md:max-w-[400px] lg:max-w-[700px] xl:max-w-[700px]"
              />
            </motion.div>
          </div>
        </section>
