...
const About = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row items-center gap-10 md:gap-15 lg:gap-60 max-w-6xl mx:auto lg:ml-20">
      <img
        src=
        {about}
      ...
      <div className="md:w-1/2">
        <p className="text-md md:text-lg lg:text-2xl text-center leading-relaxed font-[">
        ...
        <h3 className='text-md md:text-xl lg:text-3xl text-center koh-santepheap-light'>Designed To be Useful <br></br>Made To Be Soulful</h3>
      </div>
    </div>
    </FadeInOnView>
  </section>
