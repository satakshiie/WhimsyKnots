...
const About = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row items-center gap-10 md:gap-60 max-w-6xl mx:auto md:ml-8">
      <img
        src=
        {about}
      ...
      <div className="md:w-1/2">
        ...
        At whimsy knots, every creation tells a story. We make everyday pieces-bags, coasters, keychains and more- crocheted  by hand and heart.</p>
        <h3 className='text-md md:text-3xl text-center font-[Koh Santepheap]'>Designed To be Useful <br></br>Made To Be Soulful</h3>
      </div>
    </div>
  </section>
